...
async function FetchPokeData1(id) {
    ...
    document.getElementById("move1").addEventListener("click", () => Battle(poke_id_1, poke_id_2, data.moves[0].move.name));

    document.getElementById("move2").innerText = data.moves[1].move.name;
    document.getElementById("move2").addEventListener("click", () => Battle(poke_id_1, poke_id_2, data.moves[1].move.name));

    document.getElementById("move3").innerText = data.moves[2].move.name;
    document.getElementById("move3").addEventListener("click", () => Battle(poke_id_1, poke_id_2, data.moves[2].move.name));

    document.getElementById("move4").innerText = data.moves[3].move.name;
    document.getElementById("move4").addEventListener("click", () => Battle(poke_id_1, poke_id_2, data.moves[3].move.name));
}
...
async function FetchPokeData2(id) {
    ...
    document.getElementById("move5").addEventListener("click", () => Battle(poke_id_2, poke_id_1, data.moves[0].move.name));

    document.getElementById("move6").innerText = data.moves[1].move.name;
    document.getElementById("move6").addEventListener("click", () => Battle(poke_id_2, poke_id_1, data.moves[1].move.name));

    document.getElementById("move7").innerText = data.moves[2].move.name;
    document.getElementById("move7").addEventListener("click", () => Battle(poke_id_2, poke_id_1, data.moves[2].move.name));

    document.getElementById("move8").innerText = data.moves[3].move.name;
    document.getElementById("move8").addEventListener("click", () => Battle(poke_id_2, poke_id_1, data.moves[3].move.name));
